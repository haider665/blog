...
<!-- 							<a href="index.html"> -->
<%-- 								<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo.png" alt=""> --%>
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="col-lg-8 col-md-8 col-sm-12 logo-right no-padding ads-banner"> -->
<%-- 							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/banner-ad.jpg" alt=""> --%>
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
					<c:url var="postAdd" value="addPost">
						<c:param name="userId" value="${user}"></c:param>
					</c:url>
					...
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<ul>
								...
								<li><a href="postAdd">Add Post</a></li>
								<li><a href="audio-post.html">Your Post</a></li>
							</ul>
						</li>
						<li><a href="${ postAdd}">Add Post</a></li>
						<li><a href="contact.html">${user.email}</a></li>
					</ul>
...
<%-- 								<img class="img-fluid" src="${pageContext.request.contextPath}/resources/image/10.png" alt=""> --%>
<!-- 							</div> -->
...
<!-- 								<div class="feature-image-thumb relative"> -->
<!-- 									<div class="overlay overlay-bg"></div> -->
<%-- 									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/top-post2.jpg" alt=""> --%>
<!-- 								</div> -->
<!-- 								<div class="top-post-details"> -->
<!-- 									<ul class="tags"> -->
<!-- 										<li><a href="#">Food Habit</a></li> -->
...
<!-- 								<div class="feature-image-thumb relative"> -->
<!-- 									<div class="overlay overlay-bg"></div> -->
<%-- 									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/top-post3.jpg" alt=""> --%>
<!-- 								</div> -->
<!-- 								<div class="top-post-details"> -->
<!-- 									<ul class="tags"> -->
<!-- 										<li><a href="#">Food Habit</a></li> -->
...
<!-- 								<h4 class="cat-title">Latest News</h4> -->
							<c:forEach var="post" items="${allPost}" >
								...
								<c:url var="viewPost" value="viewPost">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="${pageContext.request.contextPath}/resources/image/${post.postId }.png" alt="">
										</div>
										<ul class="tags">
...
<!-- 									<div class="feature-img relative"> -->
<!-- 										<div class="overlay overlay-bg"></div> -->
<%-- 										<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/f1.jpg" alt=""> --%>
<!-- 									</div> -->
<!-- 									<div class="details"> -->
<!-- 										<ul class="tags"> -->
<!-- 											<li><a href="#">Food Habit</a></li> -->
...
<!-- 											<div class="feature-img relative"> -->
<!-- 												<div class="overlay overlay-bg"></div> -->
<%-- 												<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/f2.jpg" alt=""> --%>
<!-- 											</div> -->
<!-- 											<ul class="tags"> -->
...
<!-- 											<div class="feature-img relative"> -->
<!-- 												<div class="overlay overlay-bg"></div> -->
<%-- 												<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/f3.jpg" alt=""> --%>
<!-- 											</div> -->
<!-- 											<ul class="tags"> -->
<!-- 												<li><a href="#">Travel</a></li> -->
<!-- 											</ul> -->
...
<!-- 											<div class="feature-img relative"> -->
<!-- 												<div class="overlay overlay-bg"></div> -->
<%-- 												<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/r2.jpg" alt=""> --%>
<!-- 											</div> -->
<!-- 											<ul class="tags"> -->
...
<!-- 											<div class="feature-img relative"> -->
<!-- 												<div class="overlay overlay-bg"></div> -->
<%-- 												<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/r3.jpg" alt=""> --%>
<!-- 											</div> -->
<!-- 											<ul class="tags"> -->
<!-- 												<li><a href="#">Travel</a></li> -->
<!-- 											</ul> -->
...
<!-- 											<div class="feature-img relative"> -->
<!-- 												<div class="overlay overlay-bg"></div> -->
<%-- 												<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/e1.jpg" alt=""> --%>
<!-- 											</div> -->
<!-- 											<ul class="tags"> -->
<!-- 												<li><a href="#">Travel</a></li> -->
<!-- 											</ul> -->
...
<!-- 												<div class="thumb"> -->
<%-- 													<img src="${pageContext.request.contextPath}/resources/img/e2.jpg" alt=""> --%>
<!-- 												</div> -->
<!-- 												<div class="detail"> -->
...
<!-- 											<div class="single-post d-flex flex-row"> -->
<!-- 												<div class="thumb"> -->
<%-- 													<img src="${pageContext.request.contextPath}/resources/img/e3.jpg" alt=""> --%>
<!-- 												</div> -->
<!-- 												<div class="detail"> -->
...
<!-- 											<div class="single-post d-flex flex-row"> -->
<!-- 												<div class="thumb"> -->
<%-- 													<img src="${pageContext.request.contextPath}/resources/img/e4.jpg" alt=""> --%>
<!-- 												</div> -->
<!-- 												<div class="detail"> -->
...
<%-- 									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/sidebar-ads.jpg" alt=""> --%>
<!-- 								</div> -->
...
<!-- 										<div class="thumb"> -->
<%-- 											<img src="${pageContext.request.contextPath}/resources/img/m1.jpg" alt=""> --%>
<!-- 										</div> -->
<!-- 										<div class="details"> -->
<!-- 											<a href="image-post.html"> -->
...
<!-- 									<div class="single-list flex-row d-flex"> -->
<!-- 										<div class="thumb"> -->
<%-- 											<img src="${pageContext.request.contextPath}/resources/img/m2.jpg" alt=""> --%>
<!-- 										</div> -->
<!-- 										<div class="details"> -->
<!-- 											<a href="image-post.html"> -->
...
<!-- 									<div class="single-list flex-row d-flex"> -->
<!-- 										<div class="thumb"> -->
<%-- 											<img src="${pageContext.request.contextPath}/resources/img/m3.jpg" alt=""> --%>
<!-- 										</div> -->
<!-- 										<div class="details"> -->
<!-- 											<a href="image-post.html"> -->
...
<!-- 									<div class="single-list flex-row d-flex"> -->
<!-- 										<div class="thumb"> -->
<%-- 											<img src="${pageContext.request.contextPath}/resources/img/m4.jpg" alt=""> --%>
<!-- 										</div> -->
<!-- 										<div class="details"> -->
<!-- 											<a href="image-post.html"> -->
<!-- 												<h6>5 Tips For Offshore Soft -->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
		...
		<script src="${pageContext.request.contextPath}/resources/js/mn-accordion.js"></script>
