...
<!-- 								</div> -->
							...
							<div class="comment-form">
								<h4>Post Comment</h4>
								<form:form modelAttribute="comment" action="addComment">
...
<!-- 										</div> -->
									...
									<div class="form-group">
										<form:textarea path="comment" class="form-control mb-10" rows="5" name="message" placeholder="Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""/>
									</div>
